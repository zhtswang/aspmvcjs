    ...
    , function ($, _, Backbone) {
        return (function () {
            ...
            var Form = Backbone.View.extend({
                ...
                className:'bbf-form control-group',
                 ...
                 *          schema  {Array}
                 *      Optional:
                 *          model   {Backbone.Models} : Use instead of data, and use commit().
            ...
            var Field = Backbone.View.extend({
                ...
                className:'bbf-field control-group',
                 ...
                 *          model       {Backbone.Models} : Use instead of value, and use commit().
                ...
                render:function () {
                    var schema = this.schema,
                        el = $(this.el);
                    el.addClass('bbf-field' + schema.type).addClass("field-"+this.key);
             ...
             <label for="{{id}}">{{title}} {{required}}</label></div>\
             <div class="bbf-editor controls bbf-editor{{type}}"></div>\
        ')
            ...
            editors.Base = Backbone.View.extend({
                ...
                initialize:function (options) {
                    ...
                    if (options.model) {
                        ...
                        if (_.str.isBlank(modelType)) modelType = "form";
                        this.model = options.model;
                        this.key = options.key;
